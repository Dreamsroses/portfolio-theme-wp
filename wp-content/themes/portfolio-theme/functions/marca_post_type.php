...
if ( ! function_exists('marca_post_type') ) {

// Register Custom Post Type
function marca_post_type() {
	...
	$labels = array(
		...
		'name_admin_bar'        => __( 'Marca', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'marca portafolio', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'marca_post_type', 0 );
