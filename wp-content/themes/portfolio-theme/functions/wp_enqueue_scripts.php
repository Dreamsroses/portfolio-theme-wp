...
function dl_enqueue_scripts() {
	...
	wp_register_script('jquery-bootstrap', get_theme_file_uri('/assets/js/lib/bootstrap.min.js'), null, null, true);
	wp_register_script('jquery-migrate', get_theme_file_uri('/assets/js/lib/jquery-migrate.min.js'), array('jquery'), '3.0.0', true);
	wp_register_script( 'main_js', get_theme_file_uri('/assets/js/functions.js'), array('jquery-migrate', 'jquery-bootstrap'), $theme_data->get( 'Version' ), true );
